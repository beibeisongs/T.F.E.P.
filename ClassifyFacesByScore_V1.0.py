    ...
    for i in range(len(belonger)):
        ...
        if error == "OK":
            ...
            if gender == "Female":
                ...
                jpg_path = dirpath + "\\" + str(belonger_i) + "\\" + str(belonger_i) + ".jpg"
                print("jpg_path : " + jpg_path)
                destination = "D:\\用户的文件\\ScoreRegions_female\\" + score_level_filename + "\\" + str(belonger_i) + ".jpg"
                ...
                jpg_path = dirpath + "\\" + str(belonger_i) + "\\" + str(belonger_i) + ".jpg"
                print("jpg_path : " + jpg_path)
                destination = "D:\\用户的文件\\ScoreRegions_male\\" + score_level_filename + "\\" + str(belonger_i) + ".jpg"
                print("destination : " + destination)
