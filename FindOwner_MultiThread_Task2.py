...
def write_ResultJson(Max_Number, desc_link_jpgname, document_path, total_list, sum_SubFaceNames, dirpath, get_user_id):
    ...
    try:
        ...
        dirpath = dirpath + "\\" + get_user_id + "\\" + "Error Mark"  # <Sample>: D:\\用户的文件\\广东省\\广州市\\18811860\\Ext_Step_Ok
...
def analysor(document_path, get_user_id):   # <Sample>: document_path = 'C:\\用户的文件\\湖北省\\武汉市\\1982819117\\1982819117'
    ...
    for dirpath, dirnames, filenames in os.walk(document_path): # <Sample>: dirpath = 'C:\\用户的文件\\湖北省\\武汉市\\1982819117\\1982819117'
        ...
        write_ResultJson(Max_Number, desc_link_jpgname, document_path, total_list, sum_SubFaceNames, dirpath, get_user_id)
...
# start_pt = input()
start_pt = 120000    # <Attention>: 注意！这个账号中是一定有Ext_Step_Ok文件夹的，所以如果后面遇到No Ext_Step_Ok ! 则一定是Faces_Extraction_MultiThread_Test2.py还没有将人脸提取出来
